...
exports.handler = (event, context, callback) => {
   ...
   headers['Content-Security-Policy'] = [{key: 'Content-Security-Policy',  value: "default-src 'none'; connect-src https://api.jugofpunch.com/dev/booze; img-src 'self'; script-src 'self'; style-src 'self'"}];
